...
if (!defined(PICKLIST_VERSION))
    define(PICKLIST_VERSION, '1.2.1');
...
if (!class_exists('WC_PickList')) :
    ...
    class WC_PickList
    {
        ...
        public function install()
        {
            ...
            add_option('picklist_forceconfirm', "yes");
            update_option('picklist_version', PICKLIST_VERSION);
        }

        public function checkVersion()
        {
            if (PICKLIST_VERSION !== get_option('picklist_version')){
                update_option('picklist_version', PICKLIST_VERSION);
            }
    ...
    add_action('plugins_loaded', array('WC_PickList', 'checkVersion'));
