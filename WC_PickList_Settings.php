    ...
    class WC_PickList_Settings
    {
        ...
        private static function picklist_settings_content() {
            $settings = array(
                ...
                "picklist_forceconfirm" => array(
                    'id'                => 'picklist_forceconfirm',
                    'title'             => __( 'Force confirmation of an item', 'wc-picklist' ),
                    'type'              => 'checkbox',
                    'desc'       => __( 'Force your warehouse worker to confirm the item first before it can be picked', 'wc-picklist' ),
                ),
